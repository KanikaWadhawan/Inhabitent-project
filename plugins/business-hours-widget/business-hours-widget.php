 ...
 * @author    Kanika Wadhawan<wadhawan.kanika@gmail.com>
 * @license   GPL-2.0+
 * @link      http://github.com/kanikawadhawan
 * @copyright 2019 Hipster Camping Co.
 *
 * @wordpress-plugin
 * Plugin Name:       Inhabitent Business Hours Widget
 * Plugin URI:        http://github.com/kanikawadhawan
 * Description:       First Widget created to display business hours
 * Version:           1.0.0
 * Author:            Kanika Wadhawan
 * Author URI:        http://github.com/kanikawadhawan
 * License:           GPL-2.0+
...
class Tent_Biz_Hours extends WP_Widget {
	...
	public function update( $new_instance, $old_instance ) {
		...
		$instance['monday_friday'] = strip_tags( trim($new_instance['monday_friday']) );
		$instance['saturday'] = strip_tags( trim($new_instance['saturday']) );
		$instance['sunday'] = strip_tags( trim($new_instance['sunday']) );
		return $instance;
